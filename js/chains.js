...
// const getAvailableCarNames = carsArr => {
//   return carsArr.filter(el => el.onSale).map(el => el.model);
// };
...
// const getSortedCarsOnSale = carsArr => {
//   return carsArr.filter(el => el.onSale).sort((a, b) => a.price - b.price);
// };
