...
1 Ітерація
acc = 0;
el = { make: 'Honda', model: 'CR-V', type: 'suv', amount: 14, price: 24045, onSale: true };
idx = 0;
arr = 
...
2 Ітерація
acc = 14
el = { make: 'Honda', model: 'Accord', type: 'sedan', amount: 2, price: 22455, onSale: true }
idx = 1;
arr = 
...
//   return carsArr.reduce((acc, el, idx, arr) => {
//     return acc + el.amount;
//   }, 0);
// };
