...
/*
? Напиши функцію getStockReport(stockInfo), щоб вона приймала об'єкт параметрів із властивостями companyName і stock і виводила репорт
? про кількість товарів на складі будь-якої компанії.
*/

// function getStockReport(stockInfo) {
//   const { companyName, stock } = stockInfo;

//   let total = 0;
//   const stockValues = Object.values(stock);

//   for (const values of stockValues) {
//     total += values;
//   }
