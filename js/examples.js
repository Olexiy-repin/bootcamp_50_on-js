...
// mango.email = 'bunvo@jaen.ve';
// console.log(mango.email); // bunvo@jaen.ve
...
//   removeNote(text) {
//     this.items = this.items.filter(el => el.text.toLowerCase() !== text.toLowerCase());
//   }

//   updatePriority(text, newPriority) {
//     const note = this.items.find(el => el.text.toLowerCase() === text.toLowerCase());
